      ...
      <ScrollView>
        ...
        <View style={{ ...styles.container }}>
          ...
          <View>
            ...
            >
              <Checkbox value="Just Listed" my="1">
                Just Listed
              </Checkbox>
              <Checkbox value="Include Pending" my="1">
                Include Pending
              </Checkbox>
              <Checkbox value="Include Sold" my="1">
                Include Sold
              </Checkbox>
              <Checkbox value="Foreclosure" my="1">
                Foreclosure
              </Checkbox>
              <Checkbox value="Short Sale" my="1">
                Short Sale
              </Checkbox>
            </Checkbox.Group>
          </View>
