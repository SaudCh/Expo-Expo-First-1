    ...
    <View style={{ ...styles.container }}>
      ...
      <View style={{ flexDirection: "row" }}>
        <TouchableOpacity style={{ ...styles.btnContainer }}>
          <AntDesign name="hearto" size={24} color="#0078B3" />
        </TouchableOpacity>
        <TouchableOpacity style={{ ...styles.btnContainer }}>
          <FontAwesome5 name="envelope" size={24} color="#0078B3" />
        </TouchableOpacity>
        <TouchableOpacity style={{ ...styles.btnContainer }}>
          <Ionicons name="ios-alarm-outline" size={24} color="#0078B3" />
        </TouchableOpacity>
        <TouchableOpacity style={{ ...styles.btnContainer }}>
          <FontAwesome name="eye" size={24} color="#0078B3" />
        </TouchableOpacity>
      </View>
    </View>
  );
