...
export default function Info() {
  return (
    <View style={{ padding: 10 }}>
      ...
      />
      <View style={{ ...styles.InfoNumberContainer, alignItems: "flex-start" }}>
        <View
          style={{
            ...styles.InfoNumber,
        ...
        >
          <Text style={{ ...styles.InfoNumberText, color: "#ff9800" }}>01</Text>
        </View>
      </View>
      ...
      <View style={{ ...styles.InfoNumberContainer, alignItems: "flex-end" }}>
        ...
        >
          <Text style={{ ...styles.InfoNumberText, color: "#07ad59" }}>02</Text>
        </View>
      </View>
      <Text style={{ ...styles.InfoHeading }}>
      ...
      <Image
        ...
        style={{ ...styles.InfoImage }}
      />
      <View style={{ ...styles.contactUs }}></View>
