  ...
  const sendMessage = async () => {
    try {
      const response = await fetch(
        `https://first1.us/api/sendMessage.php?name=testing&email=testing&phone=testing&message=testing&subject=12`
      );
          ...
          <View style={{ margin: 40 }}>
            ...
            >
              <TouchableOpacity
                ...
                onPress={() =>
                  Linking.openURL(
                    "https://www.facebook.com/First1-101894422259628"
                  )
                }
              >
                <FontAwesome name="facebook-square" size={30} color="#FF7837" />
              </TouchableOpacity>
              <TouchableOpacity
                style={{
                  backgroundColor: "#FFF1EA",
                ...
                // }
              >
                <FontAwesome name="twitter-square" size={30} color="#FF7837" />
              </TouchableOpacity>
              <TouchableOpacity
                style={{
                  backgroundColor: "#FFF1EA",
                ...
                onPress={() =>
                  Linking.openURL("https://www.instagram.com/first1.us/")
                }
              >
                <FontAwesome name="instagram" size={30} color="#FF7837" />
              </TouchableOpacity>
            </View>
          </View>
        </View>
