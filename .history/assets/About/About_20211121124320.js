...
export default function Buy(props) {
  return (
    <NativeBaseProvider>
      ...
      <ScrollView>
        <ImageBackground
          source={require("../img/about-head.jpg")}
          resizeMode="cover"
          style={{
            height: 200,
            width: "100%",
        ...
        <View style={{ padding: 10 }}>
          ...
          <Text style={{ ...styles.LowerText }}>
            Let us guide you through the complexities of buying or selling your
            home, eliminating hassles and stress. We look forward to being a
            part of a new and exciting chapter in your life!
          </Text>
          <Button
            style={{
              marginVertical: 10,
