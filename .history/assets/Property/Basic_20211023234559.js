...
export default function Basic(props) {
  ...
  return (
    <View style={{ ...styles.card2 }}>
      ...
      >
        {item.PotentialShortSaleYN === "1" ? (
          <View></View>
        ) : (
          <Button
            style={{ width: "45%", backgroundColor: "rgba(255, 87, 34,0.1)" }}
          >
            <AntDesign name="check" size={24} color="#ff5722" />
            <Text style={{ color: "#ff5722" }}>Short Sale</Text>
          </Button>
        )}
        {item.ForeclosedREOYN === "1" ? (
          <View></View>
        ) : (
          <Button
            style={{ width: "45%", backgroundColor: "rgba(255, 87, 34,0.1)" }}
          >
            <Text style={{ color: "#ff5722" }}>Foreclosure</Text>
          </Button>
        )}
      </View>
