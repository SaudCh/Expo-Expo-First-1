  ...
  return (
    <View style={{ ...styles.card }}>
      ...
      <View>
        ...
        <View style={{ ...styles.box }}>
          <Text style={{ ...styles.upperText }}>
            {JSON.parse(item.other_fields_json).TaxDesc}
          </Text>
          <Text style={{ ...styles.lowerText }}>Tax Description</Text>
        </View>
        <View style={{ ...styles.box }}>
          <Text style={{ ...styles.upperText }}>
            {JSON.parse(item.other_fields_json).TaxDistrictType}
          </Text>
          <Text style={{ ...styles.lowerText }}>Tax District Type</Text>
        </View>
      </View>
    </View>
  );
